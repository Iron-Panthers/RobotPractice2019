...
public class ArmCargoShipCargoBack extends Command {
  public double pow;
  public ArmCargoShipCargoBack() {
  ...
  protected void initialize() {
    Robot.arm.target = 180 - Robot.arm.armToTarget(Constants.Arm.CARGO_SHIP_HEIGHT);
  }
