...
<<<<<<< HEAD
    public static final int JOYSTICK_PORT = 1; //or 2 joystick for intake
    public static final int JOYSTICK_INTAKE_BUTTON_PORT = 2; //side button, intake
=======
    public static final int JOYSTICK_PORT = 2; //joystick for intake
    public static final int JOYSTICK_INTAKE_BUTTON_PORT = 4; //side button, intake
>>>>>>> Intake
    public static final int JOYSTICK_OUTTAKE_BUTTON_PORT = 3; //top close left, outtake
...
=======
    public static final int HATCH_OUTTAKE_PISTONS_SOLDNOID_PORT = 0; //yeets pistons
>>>>>>> Intake
